...
% rounded
% 0.21app - Added NTCHS calculations
% 0.22app - Split readtable into numeric and text and fixed bug in
...
Parameters_Num=readtable(app.Inputfile.Value,'Sheet','Parameters','Range','A1:B21','ReadVariableNames',0,'ReadRowNames',1);
Parameters_Text=readtable(app.Inputfile.Value,'Sheet','Parameters','Range','A22:B27','ReadVariableNames',0,'ReadRowNames',1);
...
switch IRIS_Type
    case {'Mn','Fe'}
        ...
        I_start_Munsell=MUNSELL_MATCH(I_start_clustercolors, app.Inputfile.Value);
        ...
        I_end_Munsell=MUNSELL_MATCH(I_end_clustercolors, app.Inputfile.Value);
...
%   ParamFile is the input parameter file with a Munsell tab
